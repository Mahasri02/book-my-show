...
const movies: Movie[] = [
  ...
  },
  {
    id: '5',
    title: 'Kadamban',
    tagline: 'A tribal hero protects his forest from corporate greed.',
    overview: 'A native of a tribal village in a forest takes on a large corporate house that wants to destroy his homeland to mine for minerals.',
    releaseYear: 2017,
    genres: ['Action', 'Drama'],
    rating: 4.1,
    duration: '2h 20m',
    posterImageId: 'movie-poster-kadamban',
    heroImageId: 'movie-hero-kadamban',
    posterImageUrl: 'https://th.bing.com/th/id/OIP.__V0LLwTJOqevxeY049MXAHaEK?w=333&h=187&c=7&r=0&o=7&cb=ucfimg2&dpr=1.3&pid=1.7&rm=3&ucfimg=1',
    heroImageUrl: 'https://images.unsplash.com/photo-1506929562872-bb421503ef21?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
    reviews: [
      { id: 'r5-1', author: 'ActionFan', rating: 4, text: 'Visually stunning with great action sequences. Arya is convincing as a forest dweller.' },
      { id: 'r5-2', author: 'EcoWarrior', rating: 4, text: 'An important message about protecting our environment. The movie is a good watch.' },
    ],
    showtimes: [
  ...
  },
  {
    id: '6',
    title: 'Vaathi',
    tagline: 'Education is for everyone.',
    overview: 'A passionate teacher takes on the corrupt education system to provide quality education to underprivileged students.',
    releaseYear: 2023,
    genres: ['Drama'],
    rating: 4.6,
    duration: '2h 19m',
    posterImageId: 'movie-poster-vaathi',
    heroImageId: 'movie-hero-vaathi',
    posterImageUrl: 'https://th.bing.com/th/id/OIP.xu9SRAnOgxrLSDYO0PPaigHaEH?w=254&h=180&c=7&r=0&o=7&cb=ucfimg2&dpr=1.3&pid=1.7&rm=3&ucfimg=1',
    ...
    reviews: [
      { id: 'r6-1', author: 'EduActivist', rating: 5, text: 'A powerful film with a strong message. Dhanush delivers an excellent performance.' },
      { id: 'r6-2', author: 'CinemaGoer', rating: 4, text: 'An engaging drama that keeps you hooked. The classroom scenes are the highlight.' },
    ],
    showtimes: [
