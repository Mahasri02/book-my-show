...
const movies: Movie[] = [
  ...
  },
  {
    id: '6',
    title: 'Vikram',
    tagline: 'A high-octane action film which is a part of the Lokesh Cinematic Universe.',
    ...
    reviews: [
      { id: 'r6-1', author: 'KamalFan', rating: 5, text: 'Ulaganayagan is back with a bang! A true cinematic experience.' },
      { id: 'r6-2', author: 'ActionLover', rating: 5, text: 'Non-stop action and a gripping story. The entire cast was brilliant.' },
    ],
    showtimes: [
